...
describe('createDefaultChartConfig', () => {
  it('returns an independent configuration', () => {
    ...
    expect(second).toMatchObject({
      ...
      slopeShowChange: false,
      slopeChangeFormat: 'absolute',
      slopeChangePosition: 'middle',
      slopeChangePercentDecimals: 0,
      slopeColorByChange: false,
      slopeIncreaseColor: '#168a72',
      slopeDecreaseColor: '#db5a5a',
      slopeNeutralColor: '#777580',
