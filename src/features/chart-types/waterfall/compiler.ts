...
export function compileNativeWaterfallScene(table: DataTable, sourceConfig: ChartConfig): NativeWaterfallChartScene {
  ...
  return { ...base, compatibilityConfig: config, elements, guides: [], plot: { kind: 'waterfall', categories, categoryAxis: base.plot.categoryAxis, valueAxis: base.plot.valueAxis, valueDomain, barWidth: config.barWidth ?? 68, marks, connectors } }
}
