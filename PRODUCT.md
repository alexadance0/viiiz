...
Minimalist, strict, professional.

The desired design language is strict editorial / typographic product design on a white background. Expression should come from typography, empty space, rhythm, alignment, and precise color accents rather than decorative graphics. Accent color should be used sparingly as a background highlight behind a word, symbol, selected state, or key UI element, not as a generic text color.
...
1. Chart first, interface second: the chart canvas is the user's main object of attention; tools should frame it without stealing focus.
2. Fast path with depth: common workflows should feel obvious, while advanced customization should be available through clear progressive structure.
3. Editorial restraint: use typography, spacing, rhythm, and precise alignment as the primary visual material.
4. Sparse, meaningful accent: color marks state, selection, emphasis, and action; it is not background decoration.
5. Professional confidence: every control should feel stable, predictable, and trustworthy enough for analytical work.

## Accessibility & Inclusion

Target WCAG AA by default. Body text and controls need strong contrast, and charts, statuses, and validation states must not rely on color alone. Keyboard access should cover key workflows, focus states should be visible, and motion should respect reduced-motion preferences.
